...
<<<<<<< HEAD
        ...
        <style>
            body {
                ...
                background-image: url({{asset('img/backgroundg.jpg')}});
            }
=======
...
>>>>>>> 1723db94a46ac3b463935df52c11dd8b8964ecd5
        </style>
...
<<<<<<< HEAD
      ...
      <h2 class="mt-6 text-center text-3xl font-extrabold text-gray-900">QUESTIONS POUR UN RATON</h2>
=======
    ...
    <form class="mt-8 space-y-6" action="#" method="POST">
      ...
      <div class="rounded-md shadow-sm -space-y-px">
        ...
        <div class="email">
          ...
          <input id="email-address" name="email" type="email" autocomplete="email" required class="appearance-none rounded-none relative block w-full px-3 py-2 border border-gray-300 rounded-t-md focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 focus:z-10 sm:text-sm"
          placeholder="Entrez votre adresse mail">
        </div>
        
        <div class="password">
          <label for="password" class="sr-only">Mot de passe</label>
          <input id="password" name="password" type="password" autocomplete="current-password" required class="appearance-none rounded-none relative block w-full px-3 py-2 border border-gray-300 rounded-b-md focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 focus:z-10 sm:text-sm" 
