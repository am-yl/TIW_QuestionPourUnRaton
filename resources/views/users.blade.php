        ...
        <table>
            ...
            <tbody>
                @foreach($users as $user)
                    <tr>
                        <td class="px-4 mb-2 text-center">{{ $user->id }}</td>
                        <td class="px-4 mb-2">{{ $user->name }}</td>
                        <td class="px-4 mb-2">{{ $user->surname }}</td>
                        <td class="px-4 mb-2">{{ $user->email }}</td>
                        <td class="px-4 mb-2">@if(isset($user->role)) {{ $user->role->name }} @endif</td>
                        <td class="px-4 mb-2">{{ $user->groupe->name }}</td>
